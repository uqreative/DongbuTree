$(document).ready(function() {
    ...
    function openProduct() {
      ...
      const popup = document.getElementById('productView');
      const closeBtn = document.getElementById('close');
      var scrolla;
      ...
      if (product) {
        $('.products .product').click(function(e) {
          ...
          let text = $(this).find('figcaption p').text();
          scrolla = scrollY;
      ...
      $(window).click(function(e) {
          if ($(e.target).hasClass('productModal')) {
            $(popup).fadeOut();
            $('body').toggleClass('fixed');
            $(window).scrollTop(scrolla);
          }
    ...
    function productSlider() {
      var productThumb = new Swiper(".gallery-thumbs", {
        spaceBetween: 10,
        slidesPerView: 4,
        freeMode: true,
        watchSlidesProgress: true,
      });
      var product = new Swiper(".gallery-top", {
        spaceBetween: 20,
        slidesPerView: 1,
        navigation: {
          nextEl: ".swiper-button-next",
